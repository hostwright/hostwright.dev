...
export const TOWER_HEIGHT = 7.6;
export const DECK_HALF_HEIGHT = 0.28;
export const SHELF_Y_TOP = 1.6;
export const SHELF_Y_BOTTOM = -1.6;
...
function Shelf({ y }: { y: number }) {
  return (
    <group>
      <RoundedBox args={[TOWER_X * 2 + 0.3, DECK_HALF_HEIGHT * 2, 3.0]} radius={0.1} smoothness={4} position={[0, y, 0]}>
