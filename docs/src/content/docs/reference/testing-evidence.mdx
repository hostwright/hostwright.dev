...
repository. Status is `passed`, `failed`, or `blocked`; **every run resolves to one of
the three**.
...
The [documentation rules](/roadmap/) require every current-support
...
one of these classes for the reviewed commit.
