...
description: Hostwright is a Mac-native desired-state container platform for Apple silicon. Current capabilities and the roadmap start here.
---
...
Everything else is a **current limitation with an owner** on the [roadmap](/roadmap/), which covers trusted install, both Apple providers, complete lifecycle, images/registries/secrets, storage, networking, autonomous recovery, security/extensions, scheduling/accelerators, multi-Mac HA, Kubernetes, and the Docker ecosystem.
...
| **Release** | The release process and historical release notes. |
...
- Read [Limits, fallbacks, and safety boundaries](/overview/non-goals/) plus the exhaustive [Limitations](/reference/limitations/).
- Follow [Install from source](/getting-started/install-from-source/) and the [Quick start](/getting-started/quick-start/).
- Inspect the [roadmap](/roadmap/) before interpreting research or historical pages as current scope.
