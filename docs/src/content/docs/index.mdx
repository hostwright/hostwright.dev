...
description: Hostwright is a Mac-native desired-state container platform for Apple silicon. Current capabilities and the v0.0.2 roadmap start here.
---
...
- Inspect the [v0.0.2 roadmap](/roadmap/) before interpreting research or historical pages as current scope.
